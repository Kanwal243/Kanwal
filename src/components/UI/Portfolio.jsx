...
const Portfolio = () => {
    ...
    useEffect(() => {
        ...
        if (selectTab === 'web-design') {
            const filteredData = data.filter(items => items.category === 'Web Design')
            setPortfolios(filteredData)
        }

        if (selectTab === 'ux-design') {
            const filteredData = data.filter(items => items.category === 'Ux')
            ...
            <div className="container">
                ...
                <div className="flex items-center justify-between flex-wrap">
                    <div className="mb-7 sm:mb-0">
                        <h3 className='text-heading-Color text-[2rem] font-[700]'>
                            My recent Projects
                        </h3>
                    </div>
